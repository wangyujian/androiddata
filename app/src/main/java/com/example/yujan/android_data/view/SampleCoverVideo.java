package com.example.yujan.android_data.view;
    ...
    protected void updateStartImage() {
        ...
        if (mStartButton instanceof ImageView) {
            ...
            if (mCurrentState == CURRENT_STATE_PLAYING) {
                imageView.setImageResource(R.mipmap.iv_course_video_pause);
            } else if (mCurrentState == CURRENT_STATE_ERROR) {
                imageView.setImageResource(R.mipmap.iv_course_video_play);
            } else {
                imageView.setImageResource(R.mipmap.iv_course_video_play);
            }
        }
