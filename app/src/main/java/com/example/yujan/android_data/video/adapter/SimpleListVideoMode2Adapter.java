package com.example.yujan.android_data.video.adapter;
...
import com.example.yujan.android_data.video.VideoModel;
...
public class SimpleListVideoMode2Adapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        smallVideoHelper.addVideoPlayer(position,
                holder.imageView,
                TAG,
        ...
        holder.playerBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final String url = "http://xzb-source.oss-cn-hangzhou.aliyuncs.com/light_lesson/huaxiguan/huaixiguan_1.mp3?Expires=1604462247&OSSAccessKeyId=LTAIRnKZTqqB8g0y&Signature=fBPDtko9sOtZxYEOgUzZLzS%2B5ZY%3D";
